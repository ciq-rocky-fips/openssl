./Configure \
        ...
        --debug zlib enable-camellia enable-seed enable-rfc3779 enable-sctp \
        enable-cms enable-md2 enable-rc5 enable-ktls enable-fips \
        no-mdc2 no-ec2m no-sm2 no-sm4 enable-buildtest-c++ \
        shared linux-x86_64 -Wa,--noexecstack -Wa,--generate-missing-build-notes=yes \
        '-DDEVRANDOM="\"/dev/urandom\"" -DROCKY_FIPS_NAME="\"Rocky Linux 9 - OpenSSL FIPS Provider\"" \
        -DROCKY_FIPS_VERSION="\"Rocky9.20241015\""'\
