...
/*
 * KRB5KDF is strictly not-approved in FIPS-140-3.
 */

static int kdf_krb5kdf_fips_sli_is_approved(const EVP_KDF_IMPL *impl)
{
    return 0;
}
...
const EVP_KDF_METHOD krb5kdf_kdf_meth = {
    ...
    krb5kdf_size,
    krb5kdf_derive,
    kdf_krb5kdf_fips_sli_is_approved
};
